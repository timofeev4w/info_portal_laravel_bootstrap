...
{{-- @extends('layouts.main_background') --}}
    ...
    <div class="row">
        <div class="col-12 col-md-5">
            ...
            <form class="row g-3 needs-validation" novalidate>
                ...
                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Фамилия">
                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Регион сделать">
